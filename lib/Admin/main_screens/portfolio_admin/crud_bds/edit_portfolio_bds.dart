...
class PortfolioBdsEdit extends StatefulWidget {
  final String id, title, deskripsi, imageUrl, imageUrl2, category;
  const PortfolioBdsEdit(
      {super.key,
      required this.title,
  ...
  @override
  State<PortfolioBdsEdit> createState() => _PortfolioBdsEditState();
}

class _PortfolioBdsEditState extends State<PortfolioBdsEdit> {
