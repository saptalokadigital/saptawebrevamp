...
class PortfolioBdsAdd extends StatefulWidget {
  const PortfolioBdsAdd({super.key});

  @override
  State<PortfolioBdsAdd> createState() => _PortfolioBdsAddState();
}

class _PortfolioBdsAddState extends State<PortfolioBdsAdd> {
  List<DropdownMenuItem<String>> get dropdownItemsKategori {
    List<DropdownMenuItem<String>> menuItemsKategori = [
      DropdownMenuItem(child: Text("ERP"), value: "erp"),
      DropdownMenuItem(child: Text("MES"), value: "mes"),
    ];
