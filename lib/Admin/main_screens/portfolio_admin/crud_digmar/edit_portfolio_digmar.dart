...
class PortfolioDigmarEdit extends StatefulWidget {
  final String id, title, deskripsi, imageUrl, imageUrl2, category;
  const PortfolioDigmarEdit(
      {super.key,
      required this.title,
  ...
  @override
  State<PortfolioDigmarEdit> createState() => _PortfolioDigmarEditState();
}

class _PortfolioDigmarEditState extends State<PortfolioDigmarEdit> {
