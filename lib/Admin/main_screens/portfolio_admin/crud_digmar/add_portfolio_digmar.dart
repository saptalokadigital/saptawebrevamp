...
class PortfolioDigmarAdd extends StatefulWidget {
  const PortfolioDigmarAdd({super.key});

  @override
  State<PortfolioDigmarAdd> createState() => _PortfolioDigmarAddState();
}

class _PortfolioDigmarAddState extends State<PortfolioDigmarAdd> {
